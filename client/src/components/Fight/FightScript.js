...
//       enemy.damage +
//       Math.floor(
//         Math.random() * (Math.floor(enemy.damage * 0.05) * 2) -
//           Math.floor(enemy.damage * 0.05)
//       );
...
//       me.damage +
//       Math.floor(
//         Math.random() * (Math.floor(me.damage * 0.05) * 2) -
//           Math.floor(me.damage * 0.05)
//       );
...
//           `/money-exp/${me.id}/${me.money + enemy.money}/${me.exp + enemy.exp}`
//         );
